...
public class LC3Controller implements Initializable {
    ...
    private void calcular(ActionEvent event) {
       ...
       i2.setOpacity(1);
        ...
        matrizMalha[0][1] = Float.parseFloat(r3.getText());
        ...
        matrizMalha[1][2] = Float.parseFloat(r4.getText());
        matrizVerificacao[1][2] = 2;
        ...
        i1.setText(df.format(vetorResultado[0])+"A");
        i2.setText(df.format(vetorResultado[1])+"A");
